function [m,n,A,x,b] = SystemSetup(m,n,mat_type,beta,filepath,addgaussianfactor,corruption_scale,x_scale,normalization,randnoise,fixed_x)
    arguments
        m                   (1,1) int32
        n                   (1,1) int32
        mat_type            (1,1) string
        ...
        randnoise           (1,1) logical   = false
        fixed_x             (1,1) logical   = false
    end
    ...
    if beta > 0
        ...
        b_e(randsample(m, num_cor)) = rand(num_cor, 1) * corruption_scale;
        b                           = b + b_e;
    end
