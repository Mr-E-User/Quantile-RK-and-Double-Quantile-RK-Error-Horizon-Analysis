function [xkplus1] = dqRKalgstep(A,xk,b,q0,q1)

    % Gather matrix data, temporary computational values, quantiles Q0, Q1, and find admissible indices
    [~,n]   = size(A);
    N1tmp   = b - A * xk;
    N1      = abs(N1tmp);
    Qs      = quantile(N1,[q0,q1]);
    N2      = find((N1 >= Qs(1)) & (N1 <= Qs(2)));
